...
# updated on 220920 based on https://github.com/miyamotok0105/pytorch_handbook/blob/master/chapter7/layers/functions/detection.py
    ...
    def forward(self, num_classes, bkg_label, top_k, conf_thresh, nms_thresh, loc_data, conf_data, prior_data):
        ...
        for i in range(num):
            ...
            for cl in range(1, self.num_classes):
                ...
                scores = conf_scores[cl][c_mask] # vector of scores that exceed self.conf_thresh
                # if scores.shape[0] == 0:
                if scores.size(0) == 0:
                    continue
